...
useradd -m -s /bin/bash erzuser
echo "erzuser:$PASS" | chpasswd
usermod -aG sudo erzuser
...
echo "              reboot"
echo " "
echo " Then log back in with your new erzuser account to complete the installation."
echo " "
